...
export const offer_image_editing_2 = {
	price: '50€',
	editedPictures: 5,
	offerImages: 10,
	offerImagesPrice: '100€',
};
...
export const pricing = {
	en: {
		...
		'pricing.options.shootings': 'Photo Shootings',
		'pricing.options.editing': 'Image Editing',
		...
		'pricing.offering1.cta': 'Request Solo Shooting',
		'pricing.offering1.targetGroup': 'For individuals',
		'pricing.offering1.included.0': `${offer1.durationInHours}h outdoor shooting`,
		...
		'pricing.offering2.cta': 'Request Couple Shooting',
		'pricing.offering2.targetGroup': 'For couples',
		'pricing.offering2.included.0': `${offer2.durationInHours}h outdoor shooting`,
		...
		'pricing.offering3.description':
			'A portrait shooting is perfect for you if you want to have some professional pictures of yourself. Whether you need them for your CV, your social media profiles or just for yourself, I will make sure you get the best pictures possible.',
		'pricing.offering3.cta': 'Request Business Shootings',
		'pricing.offering3.targetGroup': 'For businesses',
		...
		'pricing.offering4.targetGroup': 'For individuals, couples, or businesses',
		'pricing.offering4.included.1': `${offer_image_editing.editedPictures} edited picture`,
		'pricing.offering5.included.1': `${offer_image_editing_2.editedPictures} edited pictures`,
	},
	de: {
		'pricing.title': 'Leistungen',
		'pricing.options.shootings': 'Fotoshootings',
		'pricing.options.editing': 'Bildbearbeitung',
		'pricing.subtitle':
		...
		'pricing.offering1.cta': 'Solo-Shooting anfragen',
		'pricing.offering1.targetGroup': 'Für Einzelpersonen',
		'pricing.offering1.included.0': `${offer1.durationInHours}h Outdoor-Shooting`,
		'pricing.offering1.included.1': `${offer1.numbOfPeople} Person`,
		...
		'pricing.offering2.cta': 'Paar-Shooting anfragen',
		'pricing.offering2.targetGroup': 'Für Paare',
		'pricing.offering2.included.0': `${offer2.durationInHours}h Outdoor Shooting`,
		'pricing.offering2.included.1': `Bis zu ${offer2.numbOfPeople} Personen`,
		...
		'pricing.offering3.cta': 'Business-Shooting anfragen',
		'pricing.offering3.targetGroup': 'Für Unternehmen',
		...
		'pricing.offering4.targetGroup': 'Für Einzelpersonen, Paare, oder Unternehmen',
		'pricing.offering4.included.1': `${offer_image_editing.editedPictures} bearbeitetes Bild`,
		'pricing.offering5.included.1': `${offer_image_editing_2.editedPictures} bearbeitete Bilder`,
	},
};
